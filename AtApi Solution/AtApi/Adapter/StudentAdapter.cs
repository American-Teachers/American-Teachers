...
{
    public class StudentAdapter : IBaseAdapter<Student>
    {
        private readonly ILogger<StudentAdapter> logger;
        private readonly AtDbContext atDbContext;

        public StudentAdapter(ILogger<StudentAdapter> logger, AtDbContext atDbContext)
        {
            this.logger = logger;
